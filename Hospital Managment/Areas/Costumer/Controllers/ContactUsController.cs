...
namespace Hospital_Managment.Areas.Costumer.Controllers
{
    ...
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumber,Email,Subject,Message")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumber,Email,Subject,Message")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
