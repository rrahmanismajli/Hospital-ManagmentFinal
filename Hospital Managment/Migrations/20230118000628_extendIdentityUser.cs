    ...
    public partial class extendIdentityUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalEquipment", x => x.MedicalEquipmentId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "InsuranceCompanyPatient",
                columns: table => new
                {
                    InsuranceCompaniesInsuranceCompanyId = table.Column<int>(type: "int", nullable: false),
                    PatientsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceCompanyPatient", x => new { x.InsuranceCompaniesInsuranceCompanyId, x.PatientsId });
                    table.ForeignKey(
                        name: "FK_InsuranceCompanyPatient_InsuranceCompanies_InsuranceCompaniesInsuranceCompanyId",
                        column: x => x.InsuranceCompaniesInsuranceCompanyId,
                        principalTable: "InsuranceCompanies",
                        principalColumn: "InsuranceCompanyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InsuranceCompanyPatient_Patients_PatientsId",
            ...
            migrationBuilder.CreateTable(
                name: "PatientInsuranceCompanies",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientInsuranceCompanies", x => new { x.PatientId, x.InsuranceCompanyId });
                    table.ForeignKey(
                        name: "FK_PatientInsuranceCompanies_InsuranceCompanies_InsuranceCompanyId",
                        column: x => x.InsuranceCompanyId,
                        principalTable: "InsuranceCompanies",
                        principalColumn: "InsuranceCompanyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientInsuranceCompanies_Patients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Bills_PatientId",
                        column: x => x.PatientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceCompanyPatient_PatientsId",
                table: "InsuranceCompanyPatient",
                column: "PatientsId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientInsuranceCompanies_InsuranceCompanyId",
                table: "PatientInsuranceCompanies",
